...
// Register routes
Route::get('/register', [AuthController::class, 'showRegister'])->middleware('partials')->name('register');
Route::post('/register', [AuthController::class, 'register'])->middleware('partials')->name('register.submit');

// Login routes
Route::get('/login', [AuthController::class, 'showLogin'])->middleware('partials')->name('login');

Route::post('/login', [AuthController::class, 'login'])->middleware('partials')->name('login.submit');
