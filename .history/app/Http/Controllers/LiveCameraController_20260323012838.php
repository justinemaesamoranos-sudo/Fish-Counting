...
{
    /**
     * Raspberry Pi Flask camera IP and port (from .env)
     */
    private $cameraIp;
    private $cameraPort;
        ...
        try {
            ...
            if ($image !== false) {
                try {
                    ...
                    $fontSize = max(1, min(5, (int)($width / 150))); // Scale font size
                    ...
                    \Log::error('Error processing image for fish count overlay: ' . $e->getMessage());
