    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .profile-menu {
            ...
            box-shadow: -8px 0 32px rgba(0, 77, 115, 0.2);
        ...
        .profile-menu form button:hover i {
            color: #E57373;
        }
        .form-grid {
            display: grid;
...
<body class="dashboard-page">
    ...
    <div class="main-content">
        <header class="dashboard-header">
            ...
            <div class="profile-dropdown">
                <button class="profile-btn" title="Open profile menu">
                    <i class="fas fa-user-circle profile-avatar"></i>
                    <span>{{ auth()->user()->first_name }}</span>
                    <i class="fas fa-chevron-down" style="font-size: 0.75rem;"></i>
                </button>
                <div class="profile-menu">
                    <button class="profile-close-btn" aria-label="Close menu">
    ...
    <script>
        ...
        // Close menu when profile close button is clicked
