    ...
    <div class="camera-grid">
        ...
        <div class="camera-feed-card">
            ...
            <div class="camera-feed-body">
                ...
                >
                <div class="fish-count-display" style="margin-top: 1rem;">
                    <p>Live Detected Fish Count</p>
                    <div id="live-fish-count-display">{{ session('fish_count', 0) }}</div>
                </div>
    ...
    captureBtn.addEventListener('click', function () {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                // Update both top and bottom count displays to stay in sync
                const topFishCount = document.getElementById('live-fish-count-display');
                const bottomFishCount = document.getElementById('fish-count-display');
                if (topFishCount) {
                    topFishCount.textContent = data.fish_count;
                }
                if (bottomFishCount) {
                    bottomFishCount.textContent = data.fish_count;
                }
