        ...
        <div class="camera-feed-card">
            ...
            <div class="camera-feed-body">
                ...
                <div class="capture-section">
                    ...
                    <span id="capture-loader" style="display:none;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    captureBtn.addEventListener('click', function () {
        ...
        .then(data => {
            ...
            if (data.success) {
                // Update fish count only
                if (fishCountDisplay) {
                    fishCountDisplay.textContent = data.fish_count;
                }

                // Show success flash
                flashMessagesDiv.innerHTML = `<div class="alert alert-success"><i class="fas fa-check-circle" style="margin-right: 0.5rem;"></i>Image captured successfully! Fish count updated.</div>`;
            } else {
