...
<div class="live-camera-container">
    ...
    <div class="camera-grid">
        {{-- Live MJPEG Feed with Fish Count --}}
        <div class="camera-feed-card">
            ...
            <div class="camera-feed-body">
                ...
                <div class="fish-count-display" id="fish-count-container">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const fishCountContainer = document.getElementById('fish-count-container');
    ...
    captureBtn.addEventListener('click', function () {
        ...
        .then(data => {
            ...
            if (data.success) {
                // Update detected fish count display
                fishCountDisplay.textContent = data.detected_fish_count;
                fishCountContainer.classList.add('active');

                // Show success flash
                flashMessagesDiv.innerHTML = `<div class="alert alert-success"><i class="fas fa-check-circle" style="margin-right: 0.5rem;"></i>Image captured successfully! Detected ${data.detected_fish_count} fish.</div>`;
            } else {
